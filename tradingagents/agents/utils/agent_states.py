...
class AgentState(MessagesState):
    ...
    options_report: Annotated[str, "Report from the Options Market Positioning Analyst"]
    sector_correlation_report: Annotated[str, "Report from the Sector/Correlation Analyst"]
