...
def register_system_settings_callbacks(app):
    ...
    @app.callback(
        [
            ...
            Output("setting-show-panel-trading", "value", allow_duplicate=True),
            Output("setting-show-panel-positions", "value", allow_duplicate=True),
            Output("setting-show-panel-options", "value", allow_duplicate=True),
            Output("setting-show-panel-reports", "value", allow_duplicate=True),
            Output("setting-show-panel-logs", "value", allow_duplicate=True),
        ],
        Input("system-settings-store", "data"),
    ...
    def load_settings_from_store(stored_settings):
        ...
        return (
            ...
            settings.get("show_panel_trading", True),
            settings.get("show_panel_positions", True),
            settings.get("show_panel_options", True),
            settings.get("show_panel_reports", True),
            settings.get("show_panel_logs", True),
        )
    ...
    @app.callback(
        ...
        [
            ...
            State("setting-show-panel-trading", "value"),
            State("setting-show-panel-positions", "value"),
            State("setting-show-panel-options", "value"),
            State("setting-show-panel-reports", "value"),
            State("setting-show-panel-logs", "value"),
    ...
    def save_settings(
        ...
        settings = {
            ...
            "show_panel_trading": show_trading,
            "show_panel_positions": show_positions,
            "show_panel_options": show_options,
            "show_panel_reports": show_reports,
            "show_panel_logs": show_logs,
        }
    ...
    def reset_to_defaults(n_clicks):
        ...
        return (
            ...
            defaults.get("show_panel_trading", True),
            defaults.get("show_panel_positions", True),
            defaults.get("show_panel_options", True),
            defaults.get("show_panel_reports", True),
            defaults.get("show_panel_logs", True),
            True,
    ...
    def import_settings_handler(contents, filename):
        ...
        try:
            ...
            return (
                ...
                imported.get("show_panel_trading", True),
                imported.get("show_panel_positions", True),
                imported.get("show_panel_options", True),
                imported.get("show_panel_reports", True),
                imported.get("show_panel_logs", True),
                True,
